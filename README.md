...
> Відкрити цю сторінку в [https://ruslanus00.github.io/time/](https://ruslanus00.github.io/time/)
...
* шукайте **https://github.com/ruslanus00/time** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/ruslanus00/time/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/ruslanus00/time** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/ruslanus00/time/raw/master/.github/makecode/blocks.png)
